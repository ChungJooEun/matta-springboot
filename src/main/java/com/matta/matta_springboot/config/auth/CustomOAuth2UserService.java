package com.matta.matta_springboot.config.auth;

import com.matta.matta_springboot.config.auth.dto.OAuthAttributes;
import com.matta.matta_springboot.config.auth.dto.SessionUser;
import com.matta.matta_springboot.domain.user.User;
import com.matta.matta_springboot.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        User user = save0rUpdate(attributes);
    ...
    private User save0rUpdate(OAuthAttributes attributes){
